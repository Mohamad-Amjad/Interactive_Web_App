...
<head>
    ...
    <title>Register - Terra Kitchen</title>
    ...
    <div class="main-wrapper">
        <div class="auth-container mt-5">
            <div class="text-center mb-4">
                ...
                <h2 class="mt-3 fw-bold">Register</h2>
            </div>
            ...
            <form method="POST" action="register.php">
                ...
                <button type="submit" class="btn btn-primary-custom w-100" style="background-color: var(--primary-orange, #f05a16); color: white; border: none; padding: 12px; border-radius: 8px; font-weight: 600;">Register</button>
                <div class="text-center mt-3">
                    Already have an account? <a href="login.php" style="color: #f05a16; text-decoration: none; font-weight: bold;">Login</a>
                </div>
            </form>
        </div>
    </div>
